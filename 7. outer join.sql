...
-- LEFT JOIN : INNER 41 + 부서 없는 사원 5 = 46건
-- RIGHT JOIN : INNER 41 + 사원 없는 부서 2 = 43건
-- FULL JOIN : INNER 41 + 부서 없는 사원 5 + 사원 없는 부서 2 = 48건
...
SELECT
    ...
    E2.emp_nm 상사명,
    E2.addr 상사주소
FROM tb_emp E1 left join tb_emp E2
